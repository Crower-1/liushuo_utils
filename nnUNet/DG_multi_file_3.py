...
def generate_image_paths(base_path, base_names):
    ...
    - image_paths: list of str
    """
    image_paths = [f"{base_path}/{base_name}/{base_name}.mrc" for base_name in base_names]
    return image_paths
...
def main():
    ...
    base_names = ['pp267', 'pp1776' ,'pp1033', 'pp4001', 'pp3266', 'p545', 'pp0312', 'pp366', 'pp1189', 'pp387']
    output_dir = '/home/liushuo/Documents/data/nnUNet/nnUNet_raw/Dataset009_10tomo_10classes'
