...
def main():
    ...
    for tomo_name in os.listdir(current_path):
        ...
        label_path = os.path.join(current_path, tomo_name, 'ves_seg', f"{base_tomo_name}_label_vesicle_ori.mrc")
        json_path = os.path.join(current_path, tomo_name, 'ves_seg', f"{base_tomo_name}_vesicle_ori.json")
