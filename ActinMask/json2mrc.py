...
def process_actin_to_mask(json_path):
    ...
    mrc_path = '/media/liushuo/data1/data/synapse_seg/pp463/Prediction/actin/distance_map.mrc'
...
# Example call
json_path = f"/media/liushuo/data1/data/synapse_seg/pp463/Prediction/actin/actin_point.json"
